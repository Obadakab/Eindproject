...
$reserveringnr = $_POST["verstopt"];
 ...
 $factuurstaus= "Betaald";
 $date = date('Y-m-d H:i:s');
 

 $query4="UPDATE factuur SET status='$factuurstaus',ts_paid='$date'
 WHERE factuurid=$facN ";

$betaalresult= mysqli_query($conn,$query4); 
...
<div class="btn-group">
    ...
    <button type="button" onClick="window.location.href='../user_dashbord.php';">Naar gebruiker dashbord</button>
