...
else
{
	...
	<thead>
		...
		<tr>
			...
			<td><form action='reserveringInfo.php' method='POST'>
            <input type='hidden' name='verstopt' value='$row[reserveringnr]'>
            <input type = 'submit' name='reserveringInfo' value='reservering info'>
            </form></td>
			
			<td><form action='reserveringWijzge.php' method='POST'>
            <input type='hidden' name='verstopt' value='$row[reserveringnr]'>
            <input type = 'submit' name='wijzig' value='wijzig'>
            </form></td>

			<td><form action='reserveringVerwijder.php' method='POST'>
            <input type='hidden' name='verstopt' value='$row[reserveringnr]'>
