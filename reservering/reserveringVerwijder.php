...
<head>
    ...
    <title>ReserveringVerwijder</title>
</head>
...
<div class='container'>
    ...
    <div calss='confirmDelet' id='confirmDelet'>
    <h1>reservering verwijderen</h1>
    <form id="deleteform" method="POST" action="reserveringVerwijderDef.php">
        <h4>Weet U zeker dat u dit record wilt verwijderen?</h4>
        <input type="hidden" name="reserveringnr" value="<?php echo $reserveringnr ?>">
        <input type="submit" name="submit" value="ja">
        <input type="button" value="nee" onClick="window.location.href='reserveringOverzicht.php'">
    </form>
</div>
<table class="tg">
<thead>
<tr>
<th class="tg-invoice-info" colspan="6"><h2>Overzicht</h2></th>
</tr>
</thead>
<tbody>
...
<td class="tg-klant-info" colspan="3">
<ul>
...
<tr>
<td class="tg-invoice-c-3r"><?php echo $klantId; ?></td>
